// <copyright file="MultipleGlyphMapDictionary.cs" company="WaterTrans">
// © 2020 WaterTrans
// </copyright>
...
{
    /// <summary>
    /// The multiple glyph map dictionary.
    /// </summary>
    internal class MultipleGlyphMapDictionary : IDictionary<ushort, ushort[]>
    {
        private readonly Dictionary<ushort, ushort[]> _internalDictionary;

        /// <summary>
        /// Initializes a new instance of the <see cref="MultipleGlyphMapDictionary"/> class.
        /// </summary>
        /// <param name="internalDictionary">The internal dictionary.</param>
        internal MultipleGlyphMapDictionary(Dictionary<ushort, ushort[]> internalDictionary)
        {
